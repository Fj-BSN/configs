  ...
  (setq-default
   ...
   '(
     ...
     (shell :variables
            ...
            ;; shell-default-term-shell "%windir%\system32\cmd.exe"
            )
   ...
   dotspacemacs-additional-packages '(solarized-dark-high-contrast
                                      doom-themes
                                      yasnippet-snippets
                                      )
...
you should place your code here."
  ...
  ;; Re-define default spacemacs keybindings
  ;; Redefine evil numbers to more closely match vim bindings
  ...
  (spacemacs/set-leader-keys (kbd "om") 'org-mode)

  ;; Add file custom extensions to major modes
  (add-to-list 'auto-mode-alist '("\\.luascn$" . lua-mode))

  ;; change editor display settings
...
(custom-set-variables
 ...
 '(highlight-symbol-colors
   (quote
    ("#3c4032" "#0c454c" "#483334" "#1f3b56" "#2e4332" "#443531" "#0a4059")))
